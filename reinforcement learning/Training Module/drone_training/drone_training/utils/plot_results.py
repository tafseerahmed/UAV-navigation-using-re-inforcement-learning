...
if __name__ == '__main__':
    ...
    parser.add_argument("-a", "--average", type=int, nargs='?', const=25, metavar="N", help="plot an averaged graph using N as average size delimiter. Default = 25")
    parser.add_argument("-i", "--interpolated", type=int, nargs='?', const=25, metavar="M", help="plot an interpolated graph using M as interpolation amount. Default = 25")
    ...
    plt.legend(('Average-LinePlot','Interploted-LinePlot','Dot-Plot','Line-Plot'), ncol=2, loc='upper left')
